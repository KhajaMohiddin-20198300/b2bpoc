 ...
 */
package com.hybris.applecommerce.test.setup;
...
import com.hybris.applecommerce.test.constants.ApplecommerceTestConstants;
import com.hybris.applecommerce.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ApplecommerceTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/applecommercetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/applecommercetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/applecommercetest/import/cstickets.impex");
			...
			importImpexFile(context, "/applecommercetest/import/csquotes.impex");
		}
	}
}
