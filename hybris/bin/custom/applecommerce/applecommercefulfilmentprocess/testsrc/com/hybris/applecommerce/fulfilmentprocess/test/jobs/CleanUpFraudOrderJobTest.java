 ...
 */
package com.hybris.applecommerce.fulfilmentprocess.test.jobs;
...
import com.hybris.applecommerce.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = ApplecommerceFulfilmentProcessConstants.ORDER_PROCESS_NAME;
