 ...
 */
package com.hybris.applecommerce.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ApplecommerceFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ApplecommerceFulfilmentProcessConstants.PARENT_PROCESS);
